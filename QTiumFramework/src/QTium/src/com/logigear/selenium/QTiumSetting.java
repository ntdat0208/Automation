...
public class QTiumSetting {
	...
	private static int objecWait = 30;
	private static int pageWait = 60;
	...
	public static void setPageWait(int pageWait) {
		QTiumSetting.pageWait = pageWait;
	}
