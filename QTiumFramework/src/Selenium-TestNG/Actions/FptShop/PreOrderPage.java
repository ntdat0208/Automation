...
public class PreOrderPage {
	...
	public void orderNow(String clientName, String clientPhone, String clientEmail) throws Exception {
	...
	public void checkPreOrderResult() throws Exception {
		QTiumAssert.verifyTrue(QTiumAutomation.isElementClickable(PreOrderPageEntity.SUCCESSFULLY_ORDER_OK_BUTTON));
	}
}
